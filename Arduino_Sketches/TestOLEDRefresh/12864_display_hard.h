...
InfoDisplayHard::InfoDisplayHard()
...
void InfoDisplayHard::updateInfo(displayData data){
...
void InfoDisplayHard::setCheckbox(bool flag){
  _checkbox = flag;
}

void InfoDisplayHard::refresh(void){
  u8g2.clearBuffer();
...
void InfoDisplayHard::clear(void){
  u8g2.clearBuffer();
  u8g2.sendBuffer();
}
